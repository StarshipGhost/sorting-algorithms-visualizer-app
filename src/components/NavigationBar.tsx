...
const NavigationBar = ({ algorithms, currentId, onIdChange, mode }: { algorithms: SortingAlgorithmProps[]; currentId: number; onIdChange: (id: number) => void; mode: "simulation" | "manual" }) => {
  return (
    <div className="p-4">
