...
const NavigationButtons = ({
  ...
  const baseClass = 'fill-sky-500 w-16 h-10 border border-solid border-blue-300 rounded-sm cursor-pointer hover:bg-sky-100 hover:border-blue-500'
  return (
    <div className="grid grid-rows-2 grid-cols-5 justify-self-center gap-x-4">
      ...
      <p className="text-neutral-800 text-lg text-center row-start-2 place-content-center">{`${stepsLength ? currentStep + 1 : currentStep} / ${stepsLength ? stepsLength : 0}`}</p>
