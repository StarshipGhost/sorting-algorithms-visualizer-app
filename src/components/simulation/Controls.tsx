...
const NavigationButtons = ({
  ...
  return (
    <div className="grid grid-rows-2 grid-cols-5 justify-self-center gap-x-3">
      ...
      <DoubleLeftArrow baseClass={baseClass} handleReset={onReset} mode={mode} />
      <LeftArrow baseClass={baseClass} handleStepBack={onStepBack} mode={mode} />
      ...
      <RightArrow baseClass={baseClass} handleStepForward={onStepForward} mode={mode} />
      <DoubleRightArrow baseClass={baseClass} handleSkipToEnd={onSkipToEnd} mode={mode} />
    </div>
  )
}
